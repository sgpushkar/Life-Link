...
import { MutualAidLeaderboard } from '../../../components/MutualAidLeaderboard';
import { DisasterScenarioBanner } from '../../../components/DisasterScenarioBanner';
...
export default function OversightPage() {
  ...
  const [activeTab, setActiveTab] = useState<'topology' | 'equity' | 'weights' | 'mutual-aid'>('topology');
  ...
  return (
    <div className="space-y-8">
      ...
      {/* WHO EMT Global Disaster Crisis Simulator Banner */}
      <DisasterScenarioBanner />
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-neutral-800 pb-3">
        <div className="flex items-center gap-1.5 p-1 rounded-lg bg-[#121214] border border-neutral-800">
          ...
          >
            ...
            <span>Mutual Aid &amp; Anti-Hoarding</span>
          </button>
        </div>
      ...
      {/* Tab 4: Mutual Aid & Anti-Hoarding Leaderboard */}
      {activeTab === 'mutual-aid' && (
        <MutualAidLeaderboard />
      )}
    </div>
  );
}
