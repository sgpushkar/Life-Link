...
import { ShieldAlert, CheckCircle2, AlertTriangle, ArrowRight, Activity, Battery, MapPin } from 'lucide-react';
...
export const DistrictMap: React.FC<{ onSelectFacility?: (fac: any) => void }> = ({ onSelectFacility }) => {
  ...
  return (
    <div className="relative w-full h-[380px] rounded-lg overflow-hidden mono-card">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none">
        <line x1="60%" y1="54%" x2="55%" y2="64%" stroke="#38383e" strokeWidth="1" strokeDasharray="3 3" />
        <line x1="28%" y1="52%" x2="48%" y2="38%" stroke="#27272a" strokeWidth="1" strokeDasharray="3 3" />
        <line x1="20%" y1="72%" x2="28%" y2="52%" stroke="#27272a" strokeWidth="1" strokeDasharray="3 3" />
        ...
        <line x1="60%" y1="54%" x2="75%" y2="60%" stroke="#27272a" strokeWidth="1" strokeDasharray="3 3" />

        {/* Moving Delivery Packet */}
      ...
      {/* Legend */}
      <div className="absolute bottom-2.5 left-3 flex items-center gap-3 text-[10px] text-neutral-400 bg-neutral-950/90 px-2.5 py-1 rounded-lg border border-neutral-800 font-mono">
